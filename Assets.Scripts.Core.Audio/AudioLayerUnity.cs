...
internal class AudioLayerUnity : MonoBehaviour
{
	...
	private Assets.Scripts.Core.Audio.AudioType audioType;
	...
	private IEnumerator WaitForLoad(string filename, Assets.Scripts.Core.Audio.AudioType type)
	{
	...
	public void PlayAudio(string filename, Assets.Scripts.Core.Audio.AudioType type, float startvolume = 1f, bool loop = false)
	{
		if (IsPlaying())
		{
			StopAudio();
