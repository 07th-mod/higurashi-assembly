...
namespace Assets.Scripts.UI
{
	...
	public class MainUIController : MonoBehaviour
	{
		...
		public void OnGUI()
		{
			...
			if ((BurikoMemory.Instance.GetFlag("GFlagMonitor").IntValue() == 1) | (BurikoMemory.Instance.GetFlag("GFlagMonitor").IntValue() == 2))
			{
			...
			if (BurikoMemory.Instance.GetFlag("GFlagMonitor").IntValue() == 2)
			{
			...
			if (BurikoMemory.Instance.GetFlag("GFlagMonitor").IntValue() >= 3)
			{
			...
			if (BurikoMemory.Instance.GetFlag("GFlagMonitor").IntValue() >= 4)
			{
