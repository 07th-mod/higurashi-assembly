...
namespace Assets.Scripts.Core.Scene
{
	public class Layer : MonoBehaviour
	{
		...
		private void EnsureCorrectlySizedMesh(int width, int height, LayerAlignment alignment, Vector2? origin, Vector2? forceSize, bool isBustShot, int finalXOffset, string texturePath, string textureNameFromGameScript, bool disableRyukishiClamp = false)
		{
